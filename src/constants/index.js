...
export const transferFilter = {
    ...
    items: {
        ...
        NO_TRANSFERS: { id: '2', title: 'Без пересадок', value: 'NO_TRANSFERS', number: 0 },
        ONE_TRANSFER: { id: '3', title: '1 пересадка', value: 'ONE_TRANSFER', number: 1 },
        TWO_TRANSFERS: { id: '4', title: '2 пересадки', value: 'TWO_TRANSFERS', number: 2 },
        THREE_TRANSFERS: { id: '5', title: '3 пересадки', value: 'THREE_TRANSFERS', number: 3 },
    },
};
...
export const formatTicket = ticket => {
    ...
    const formattedSegments = segments.map(segment => {
        ...
        return {...segment, flightStart, flightEnd, durationHours, durationMinutes}
    })
